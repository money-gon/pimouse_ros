...
class MotorTest(unittest.TestCase):
    ...
    def test_put_freq(self):
        ...
        self.file_check("rtmotor_raw_l0", m.left_hz, "wrong left from motor_raw")
        self.file_check("rtmotor_raw_r0", m.right_hz, "wrong right from motor_raw")
    ...
    def test_put_cmd_vel(self):
        ...
        self.file_check("rtmotor_raw_l0", 200, "wrong left values from cmd_vel")
        self.file_check("rtmotor_raw_r0", 600, "wrong right values from cmd_vel")

        time.sleep(1.1)
        self.file_check("rtmotor_raw_r0", 0, "don't stop after 1[s]")
        self.file_check("rtmotor_raw_l0", 0, "don't stop after 2[s]")
